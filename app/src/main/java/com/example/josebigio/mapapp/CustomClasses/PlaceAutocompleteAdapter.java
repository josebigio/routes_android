...
/**
 * Created by josebigio on 7/8/15.
 */
public class PlaceAutocompleteAdapter  extends ArrayAdapter<PlaceAutocompleteAdapter.PlaceAutocomplete> implements Filterable {
    ...
    public PlaceAutocompleteAdapter(Context context, int resource,int textViewResourceId, GoogleApiClient googleApiClient,
                                    LatLngBounds bounds, AutocompleteFilter filter) {
